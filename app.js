  ...
  function renderDetail() {
    ...
    items.forEach((it, i) => {
      ...
      nRows += "<tr" + (i === adjIndex ? ' class="fatrow"' : "") + "><td class='name'>" + escapeHtml(it.food) + (i === adjIndex ? adjLabel : "") + "</td>" +
        "<td>" + fmt(num(it.grams), 1) + "</td><td>" + fmt(m.eiweiss) + "</td><td>" + fmt(m.fett) + "</td><td>" + fmt(m.kh) + "</td><td>" + fmt(m.kcal, 0) + "</td></tr>";
    });
    ...
    c.innerHTML =
      ...
      '<div class="detail-tiles">' +
        '<div class="dstat"><div class="v">' + fmt(sumPer.kcal, 0) + '</div><div class="l">kcal</div></div>' +
