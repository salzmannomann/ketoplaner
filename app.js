  ...
  function renderDetail() {
    ...
    c.innerHTML =
      ...
      '<div class="detail-tiles">' +
        ...
        '<div class="dstat"><div class="v">≈ ' + fmt(totalG, 0) + ' g</div><div class="l">Menge' + (mult !== 1 ? '<br><small>pro Portion ≈ ' + fmt(totalG / mult, 0) + ' g</small>' : "") + '</div></div>' +
        '<div class="dstat"><div class="v">≈ ' + fmt(ml, 0) + ' ml</div><div class="l">Volumen' + (mult !== 1 ? '<br><small>pro Portion ≈ ' + fmt(ml / mult, 0) + ' ml</small>' : "") + '</div></div>' +
